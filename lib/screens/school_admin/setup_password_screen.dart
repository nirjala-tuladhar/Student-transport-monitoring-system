...
/// Screen for new school admins to set their password after clicking invitation link
...
class _SetupPasswordScreenState extends State<SetupPasswordScreen> {
  ...
  Future<void> _checkSession() async {
    ...
    if (session == null) {
      setState(() {
        _errorMessage = 'Invalid or expired invitation link. Please contact your administrator.';
      });
    }
  }
  ...
  Future<void> _setupPassword() async {
    ...
    try {
      // Update password for the authenticated user (from invitation link)
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        AnimatedButton(
                          ...
                          onPressed: (_isLoading || _success) ? null : _setupPassword,
